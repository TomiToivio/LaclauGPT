...
Before changing AI26/project behavior, inspect `paper/PAPER.md`, `docs/AI26_REFERENCE_CASE.md`, `docs/CANONICAL_DATA_CONTRACT.md`, runtime/architecture documentation and the relevant module's current public configuration/codebooks. Do not reconstruct authoritative settings from model memory.
